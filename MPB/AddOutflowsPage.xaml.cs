...
namespace MPB
{
    public partial class AddOutflowsPage : ContentPage
    {
        IFirestore firestore;
        public AddOutflowsPage()
        {
            InitializeComponent();
        ...
        async private void AddOutflows(object sender, EventArgs e)
        {
            ...
            if (String.Equals(OutflowsCategory.SelectedItem, null) || String.IsNullOrEmpty(money.Text))
            {
